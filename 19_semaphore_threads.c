...
{	pthread_t thread1, thread2, thread3;
	...
	sem_init(&sem, 0, 2);			// (pointer) (0 - bw threads || 1 - bw processes) (1 - initial count for semaphore)
									// now as the count is 1 it is acting as a mutex, but if it is increased to > 1 then it acts as a counting
									// semaphore and lets 2 threads to access the shared memory.
