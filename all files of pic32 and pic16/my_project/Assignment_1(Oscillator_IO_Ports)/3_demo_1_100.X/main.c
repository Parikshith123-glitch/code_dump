...
int main(){                         // Start of the main function 
    ...
    TRISCbits.TRISC13 = 0;          // Setting the TRISC bits 12 and 13 as output
    //TRISCbits.TRISC14 = 0;
    
    while(1){                       // Start of infinite While Loop
    
        LATCbits.LATC13 = 1;        // Setting the 13 and 14 bits as high using LATCH
        //LATCbits.LATC14 = 1;
    
        for(i = 0; i<900000; i++);  // for loop delay to observe the blinking 
    
        LATCbits.LATC13 = 0;        // Resetting the 13 and 14 bits as low
        //LATCbits.LATC14 = 0;
