...
int main(){                         // Start of the main function
    ...
    TRISCbits.TRISC14 = 0;          // Setting the TRISC(bit 13 and 14) as output 
    TRISCbits.TRISC13 = 0;
    
    while(1){                       // Start of infinite while loop

        LATCbits.LATC14 = 1;        // Setting the 13th and 14th bit as high using LATCH register
        LATCbits.LATC13 = 1; 
        
        for( i = 0; i<9000;i++);   // Loop delay to observe blinking  ( System frequency = 100MHz ) i = 4500 for 1 KHz 
                                                                                                    // i = 900 for 5 KHz
                                                                                                    // i = 300 for 13.33 KHz
                                                                                                    // i = 9000 for 500 Hz
       
        LATCbits.LATC14 = 0;        // Setting the 13th and 14th bit as low using LATCH register
        LATCbits.LATC13 = 0;  
       
        for( i = 0; i<9000;i++);   // Loop delay to observe blinking 
