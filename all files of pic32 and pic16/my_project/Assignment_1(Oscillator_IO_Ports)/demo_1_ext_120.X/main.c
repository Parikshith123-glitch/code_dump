...
int main(){                             // Start of main function 
    ...
    TRISCbits.TRISC13 = 0;              // Setting the C port 13th bit as output
    TRISCbits.TRISC14 = 0;
    
    while(1){                           // Start of infinite while loop
        
        LATCbits.LATC13 = 1;            // Setting the C port 13th and 14th bit as high
        LATCbits.LATC14 = 1;
        
        for(i = 0; i < 100000; i++);    // Delay (To observe blinking)
            
        LATCbits.LATC13 = 0;            // Resetting the C port 13th and 14th bit as low
        LATCbits.LATC14 = 0;
